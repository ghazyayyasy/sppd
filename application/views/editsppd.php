            ...
            <div class="col-sm-12">
              <section class="panel">
                ...
                <div class="panel-body">
                  <form role="form" method="post" action="<?=base_url('datasppd/Edit/'.$data->no_sppd)?>">
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Nomor SPPD</label>
                          <input type="text" name="noSPPD" id="noSPPD" class="form-control" placeholder="Input Nomor SPPD" value="<?=$data->no_sppd?>" readonly>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="date" name="tglBerangkat" id="tglBerangkat" class="form-control" value="<?=$data->tgl_berangkat?>">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Tanggal Berakhir</label>
                          <input type="date" name="tglBerakhir" id="tglBerakhir" class="form-control" value="<?=$data->tgl_berakhir?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <select name="transportBerangkat" id="transportBerangkat" class="form-control">
                            ...
                            foreach ($transportasi as $t) {
                              if ($t->id_transportasi == $data->id_transport_berangkat) {
                            ?>
                            <option value="<?=$t->id_transportasi?>" selected><?=$t->nama_transportasi?></option>
                            <?php
                              } else {
                            ?>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="transportPulang" id="transportPulang" class="form-control">
                            ...
                            <?php
                            foreach ($transportasi as $t) {
                              if ($t->id_transportasi == $data->id_transport_berakhir) {
                            ?>
                            <option value="<?=$t->id_transportasi?>" selected><?=$t->nama_transportasi?></option>
                            <?php
                              } else {
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="qty" id="qty1" class="form-control" placeholder="Input Biaya Transport Berangkat" onblur="total()" value="<?=$data->biaya_pergi?>">
                          <input type="text" name="biayaTransportBerangkat" id="biayaTransportBerangkat" value="<?=$data->biaya_pergi?>" hidden>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Biaya Transportasi Pulang</label>
                          <input type="text" name="qty" id="qty2" class="form-control" placeholder="Input Biaya Transport Pulang" onblur="total()" value="<?=$data->biaya_pulang?>">
                          <input type="text" name="biayaTransportPulang" id="biayaTransportPulang" value="<?=$data->biaya_pulang?>" hidden>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="rutePerjalanan" id="rutePerjalanan" class="form-control" placeholder="Input Rute Perjalanan" value="<?=$data->rute?>">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Pembuat SPPD</label>
                          <input type="text" name="pembuat" id="pembuat" class="form-control" placeholder="Input Pembuat SPPD" value="<?=$data->pembuat_daftar?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="tarifGP" id="tarifGP" class="form-control" value="Rp <?=number_format($data->tarif, 0, '', '.')?>" readonly>
                          <input type="text" name="tarifGPangka" id="tarifGPangka" value="<?=$data->tarif?>" hidden>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Total Biaya</label>
                          <input type="text" name="totalBiaya" id="totalBiaya" class="form-control" placeholder="Input Biaya Transport Pulang" value="<?='Rp '.number_format($data->jumlah_biaya, 0, '', '.');?>" readonly>
                          <input type="number" name="totalBiayaAngka" id="totalBiayaAngka" value="<?=$data->jumlah_biaya?>" hidden>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Maksud</label>
                          <textarea name="maksud" id="maksud" class="form-control" placeholder="Input Maksud" rows="5"><?=$data->maksud?></textarea>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="icheck">
                            <div class="square-green single-row">
                              <div class="radio ">
                                <input type="radio" name="status" id="status" value="Pengajuan ke SDM Pusat" <?php if ($data->status == 'Pengajuan ke SDM Pusat') echo 'checked';?>>
                                <label>Pengajuan ke SDM Pusat </label>
                              </div>
                            </div>
                            <div class="square-green single-row">
                              <div class="radio ">
                                <input type="radio" name="status" id="status" value="Masuk Keuangan" <?php if ($data->status == 'Masuk Keuangan') echo 'checked';?>>
                                <label>Masuk Keuangan </label>
                              </div>
                            </div>
                            <div class="square-green single-row">
                              <div class="radio ">
                                <input type="radio" name="status" id="status" value="Selesai" <?php if ($data->status == 'Selesai') echo 'checked';?>>
                                <label>Selesai </label>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-6">
                        <div class="row">
                          ...
                          <div class="col-sm-2">
                            <a href="<?=base_url('Admin/DataSPPD')?>">
